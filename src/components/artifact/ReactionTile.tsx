 ...
 * would let an undecided person commit their opinion by tapping a button that
 * never asked them to take a position. The workflow lives on the item's own
 * page; the card around this tile is the link there, and the numbers here are
 * live and read-only.
 */
