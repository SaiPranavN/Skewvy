  ...
  if (!admin) {
    ...
    return (
      <div className="mx-auto w-full max-w-2xl px-4 py-24 text-center">
        <h1 className="mt-4 text-2xl font-semibold text-primary">Administrator access required</h1>
        ...
        <Link
          href="/"
          className="mt-6 inline-flex min-h-11 items-center rounded-[var(--radius-control)] bg-primary px-4 py-2.5 text-sm font-medium text-ground transition-opacity duration-150 hover:opacity-90"
        >
          Back to Skewvy
        </Link>
      </div>
    ...
    <div className="mx-auto w-full max-w-[1400px] px-4 py-8 sm:px-6 lg:px-10">
      <div className="mb-8 flex flex-wrap items-center gap-4">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-semibold text-primary">Content management</h1>
        </div>
